...
void Decrypt(long * keys){
	...
	unsigned char buffer[] = {
		0x93, 0x91, 0x18, 0x73, 0xA0, 0x4C, 0x77, 0xC9, 0x8A, 0xCE, 0xD9, 0x9A, 0xF9, 0x20, 0xCC, 0x53,
		0x0C, 0xBE, 0x25, 0xF8, 0xCC, 0x56, 0x19, 0x37, 0x9C, 0xA2, 0xC6, 0xD1, 0x95, 0xAC, 0xE5, 0x76,
		0x22, 0xF4, 0xA3, 0x98, 0x0D, 0x27, 0xFA, 0x25, 0x15, 0x58, 0xCB, 0xDC, 0xFF, 0x33, 0xAD, 0x6D,
		0x83, 0x9F, 0xF0, 0x96, 0x7A, 0xC6, 0x5A, 0x3D, 0xD2, 0x4A, 0xA5, 0x7C, 0x52, 0x45, 0x84, 0xB8 };
	//int length = strlen((char *)buffer);
